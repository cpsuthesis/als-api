...
const typings_3 = require("../typings");
class BankingWebhookHandler {
    ...
    getGenericWebhook() {
        ...
        if (Object.values(typings_2.reportWebhooks.ReportNotificationRequest.TypeEnum).includes(type)) {
            return this.getReportNotificationRequest();
        }
        if (Object.values(typings_3.transferWebhooks.TransferNotificationRequest.TypeEnum).includes(type)) {
    ...
    getReportNotificationRequest() {
        return typings_2.reportWebhooks.ObjectSerializer.deserialize(this.payload, "ReportNotificationRequest");
    }
    getTransferNotificationRequest() {
        return typings_2.reportWebhooks.ObjectSerializer.deserialize(this.payload, "TransferNotificationRequest");
    }
}
