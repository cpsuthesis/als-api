...
export declare class RecurringApi extends Service {
    ...
    */
    deleteTokenForStoredPaymentDetails(storedPaymentMethodId: string, requestOptions?: IRequest.Options): Promise<StoredPaymentMethodResource>;
    /**
    ...
    */
    getTokensForStoredPaymentDetails(requestOptions?: IRequest.Options): Promise<ListStoredPaymentMethodsResponse>;
}
