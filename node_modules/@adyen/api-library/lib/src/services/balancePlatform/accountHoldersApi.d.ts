...
export declare class AccountHoldersApi extends Service {
    ...
    */
    getAllBalanceAccountsOfAccountHolder(id: string, requestOptions?: IRequest.Options): Promise<PaginatedBalanceAccountsResponse>;
    /**
    ...
    * @return {@link AccountHolder }
    */
    updateAccountHolder(id: string, accountHolder: AccountHolder, requestOptions?: IRequest.Options): Promise<AccountHolder>;
    /**
