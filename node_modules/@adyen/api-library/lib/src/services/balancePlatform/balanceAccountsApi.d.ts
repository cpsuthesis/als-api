...
export declare class BalanceAccountsApi extends Service {
    ...
    */
    getAllSweepsForBalanceAccount(balanceAccountId: string, requestOptions?: IRequest.Options): Promise<BalanceSweepConfigurationsResponse>;
    /**
    * @summary Get a sweep
    * @param balanceAccountId {@link string } The unique identifier of the balance account.
    * @param sweepId {@link string } The unique identifier of the sweep.
    ...
    */
    getAllPaymentInstrumentsForBalanceAccount(id: string, requestOptions?: IRequest.Options): Promise<PaginatedPaymentInstrumentsResponse>;
    /**
    ...
    * @return {@link SweepConfigurationV2 }
    */
    updateSweep(balanceAccountId: string, sweepId: string, sweepConfigurationV2: SweepConfigurationV2, requestOptions?: IRequest.Options): Promise<SweepConfigurationV2>;
    /**
    ...
    * @return {@link SweepConfigurationV2 }
    */
    createSweep(balanceAccountId: string, sweepConfigurationV2: SweepConfigurationV2, requestOptions?: IRequest.Options): Promise<SweepConfigurationV2>;
}
