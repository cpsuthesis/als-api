...
class HttpURLConnectionClient {
    ...
    createRequest(endpoint, requestOptions, applicationName) {
        ...
        requestOptions.headers[apiConstants_1.ApiConstants.ADYEN_LIBRARY_NAME] = client_1.default.LIB_NAME;
        requestOptions.headers[apiConstants_1.ApiConstants.ADYEN_LIBRARY_VERSION] = client_1.default.LIB_VERSION;
